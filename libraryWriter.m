...
add_block('simulink/User-Defined Functions/MATLAB Function', [model_name '/Enclosure']);
blockHandle = find(slroot, '-isa', 'Stateflow.EMChart', 'Path', [model_name '/Enclosure']);
blockHandle.Script = fileread('model.m');
...
add_line(model_name, 'In1_ScalarDouble/1', 'Enclosure/1');
add_line(model_name, 'Enclosure/1','Out1_ScalarDouble/1');
add_line(model_name, 'In2_ScalarUint32/1', 'Enclosure/2');
add_line(model_name, 'Enclosure/2','Out2_ScalarUint32/1');
